...
_What can recent articles on experimental research in political sceince journals teach us about how ethical standards are discussed in publications?"_
...
```{r}
yes_ethics <- ethics_docs %>% group_by(doc_id) %>% summarize(count=n())
yes_ethics
